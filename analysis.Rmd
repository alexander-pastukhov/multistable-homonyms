...
bootstrapped_data <- function(df, replace=TRUE) {
  df |>
    group_by(Participant, Time) |>
...
bootstrapped_avgs <- purrr::map_dfr(1:1000, ~bootstrapped_data(none_through_time_df))
...
ggplot(group_avgs, aes(x = Time, y = avgNone)) + 
  ...
  geom_line() +
  scale_y_continuous(name = "Average proportion of None responses") +
