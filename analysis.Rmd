...
```{r}
unistable_model <-
  brms::brm(Proportion ~ PerceptF + (1|Participant) + (1|word),
            family="beta",
            data=unistable %>% mutate(Proportion = 0.0025 + (Proportion / 100) * 0.995),
